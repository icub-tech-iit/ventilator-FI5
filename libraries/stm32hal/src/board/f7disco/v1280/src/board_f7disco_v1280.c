...
// the used timers for the pwm are: 1, 8, 12
// 
// the gpios are: 
// PA0, PF10, PF9, PF8, PF7, PB8, PB9, PI1, PB14, PB15, PA8, PA15, PI2, PH6, PI0, PG7, PB4, PG6, PC7 
...
//    MX_TIM5_Init();
    MX_TIM8_Init();
//    MX_USART1_UART_Init(); // at the moment is managed w/ code taken from ew.
...
// marco.accame: configure by ew code
///**
...
// marco.accame: configured by stm32f7bsp code (used by touch controller)
///**
...
// marco.accame: configured by stm32f7bsp
...
// marco.accame: configured by ew code
...
// marco.accame: removed tim6 because we measure time in another way
...
// not adding LTDC_IRQHandler() + DMA2D_IRQHandler() because they are elsewhere in the embedded-wizard part
