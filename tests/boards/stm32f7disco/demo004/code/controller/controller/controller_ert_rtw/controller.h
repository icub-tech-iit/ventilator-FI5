...
class controllerModelClass {
 ...
 public:
  ...
  struct P_controller_T {
    ...
    real32_T cmH2O_Gain;               // Computed Parameter: cmH2O_Gain
...
//  '<S35>'  : 'controller/Controller/Pressure Control/PID Controller/I Gain/Internal Parameters'
...
//  '<S43>'  : 'controller/Controller/Pressure Control/PID Controller/Parallel P Gain/Internal Parameters'
