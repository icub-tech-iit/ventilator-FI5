...
void FSM0ModelClass::FSM0_CPAP(void)
{
  ...
  if (guard1) {
    ...
    // Inport: '<Root>/buttons'
    FSM0_DW.condWasTrueAtLastTimeStep_1_o = (FSM0_U.buttons[ledsSTATES_tmp] ==
      Pressed);
...
void FSM0ModelClass::FSM0_latch_multiselector(void)
{
  ...
  } else if (FSM0_U.MultiSelector_Maps > 6U) {
    FSM0_DW.MultiSelector_Maps_latch = 6U;
  } else {
    ...
    if (FSM0_DW.chartAbsoluteTimeCounter - FSM0_DW.durationLastReferenceTick_4 >=
      ...
      if (FSM0_DW.chartAbsoluteTimeCounter - FSM0_DW.durationLastReferenceTick_6
        ...
        if (FSM0_DW.enter_test && (FSM0_DW.chartAbsoluteTimeCounter -
             FSM0_DW.durationLastReferenceTick_1_f >= FSM0_P.FSM_test_tmo *
             100.0F)) {
          FSM0_DW.enter_test = false;
          ...
          // Inport: '<Root>/buttons'
          FSM0_DW.condWasTrueAtLastTimeStep_1 = (FSM0_U.buttons[condIsTrue_tmp_2]
            == Pressed);
...
void FSM0ModelClass::FSM0_IDLE(void)
{
  ...
  if (FSM0_DW.chartAbsoluteTimeCounter - FSM0_DW.durationLastReferenceTick_4_g >=
    ...
    if (FSM0_DW.exit_test && (FSM0_DW.chartAbsoluteTimeCounter -
      ...
      // Inport: '<Root>/buttons'
      FSM0_DW.condWasTrueAtLastTimeStep_1_o = (FSM0_U.buttons[condIsTrue_tmp_0] ==
        Pressed);
...
void FSM0ModelClass::step()
{
  ...
  // Constant: '<S4>/Not Used 1'
  FSM0_B.MatrixConcatenate[37] = FSM0_P.NotUsed1_Value[1];
  ...
  // Constant: '<S8>/Not Used 1'
  FSM0_B.MatrixConcatenate[47] = FSM0_P.NotUsed1_Value_h[1];
