...
class FSM0ModelClass {
 ...
 public:
  ...
  typedef struct {
    real32_T MatrixConcatenate[16];    // '<S3>/Matrix Concatenate'
  } B_FSM0_T;
  ...
  typedef struct {
    ...
    int32_T durationLastReferenceTick_1_c;// '<S1>/FSM'
    ...
    int32_T durationLastReferenceTick_2_i;// '<S1>/FSM'
    int32_T durationLastReferenceTick_3_n;// '<S1>/FSM'
    int32_T durationLastReferenceTick_1_j;// '<S1>/FSM'
    int32_T durationLastReferenceTick_1_fe;// '<S1>/FSM'
    int32_T durationLastReferenceTick_4_f;// '<S1>/FSM'
    ...
    boolean_T condWasTrueAtLastTimeStep_1_k;// '<S1>/FSM'
    ...
    boolean_T condWasTrueAtLastTimeStep_1_h1;// '<S1>/FSM'
    ...
    boolean_T condWasTrueAtLastTimeStep_2_o;// '<S1>/FSM'
    boolean_T condWasTrueAtLastTimeStep_3_k;// '<S1>/FSM'
    boolean_T condWasTrueAtLastTimeStep_1_j;// '<S1>/FSM'
    boolean_T condWasTrueAtLastTimeStep_1_n;// '<S1>/FSM'
    boolean_T condWasTrueAtLastTimeStep_4_h;// '<S1>/FSM'
  } DW_FSM0_T;
  ...
  typedef struct {
    ...
    boolean_T MultiSelector_Go;        // '<Root>/MultiSelector_Go'
  } ExtU_FSM0_T;
  ...
  struct P_FSM0_T {
    ...
    real32_T blinking_period;          // Variable: blinking_period
                                          //  Referenced by: '<S1>/FSM'

    real32_T debounce_tmo;             // Variable: debounce_tmo
                                          //  Referenced by: '<S1>/FSM'

    real32_T test_tmo;                 // Variable: test_tmo
                                          //  Referenced by: '<S1>/FSM'
...
//  '<S2>'   : 'fsm/FSM/FSM'
//  '<S3>'   : 'fsm/FSM/MAPS'
//  '<S4>'   : 'fsm/FSM/MAPS/map_1'
//  '<S5>'   : 'fsm/FSM/MAPS/map_2'
