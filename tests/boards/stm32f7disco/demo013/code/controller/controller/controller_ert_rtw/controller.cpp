...
// C/C++ source code generated on : Mon May 11 13:55:17 2020
//
...
void controllerModelClass::step()
{
  ...
  if (controller_U.enable) {
    if (!controller_DW.Controller_MODE) {
      ...
      controller_B.TD_max = 3.402823466E+38F;
    ...
    rtb_LogicalOperator1 = (rtb_Compare_k || rtb_Compare_m || rtb_Compare_f);
    ...
    if ((controller_P.Controller_control_mode ==
      ...
      rtb_SumFdbk_i = controller_P.Constant_Value_a - rtb_Divide;
    }
    ...
    if (rtb_Compare_k || rtb_Compare_f) {
      ...
      rtb_Divide5 = (rtb_TmpSignalConversionAtHSCL_2 - rtb_IProdOut_d) /
        (((rtb_TmpSignalConversionAtHSCL_2 + rtb_SumFdbk) + rtb_Divide5) *
         ...
         rtb_TmpSignalConversionAtHSCL_2) * ((rtb_PIP -
        rtb_TmpSignalConversionAtHSCL_1) * controller_P.PIP_step_perc_Gain *
        controller_P.Gain3_Gain + rtb_TmpSignalConversionAtHSCL_1);
      ...
      rtb_Divide5 = rtb_SumFdbk_i - rtb_TmpSignalConversionAtHSCL_1;
    ...
    rtb_SumFdbk_i = controller_P.TidalVolume_Gain * rtb_Divide;
    ...
    if ((rtb_Compare_f && (rtb_SumFdbk_i == controller_P.Constant_Value_d)) ||
        rtb_Compare_m) {
    ...
    // End of Logic: '<S1>/Logical Operator4'
