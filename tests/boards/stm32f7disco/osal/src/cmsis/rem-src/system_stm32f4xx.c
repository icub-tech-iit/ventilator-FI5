...
#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
// IIT-EXT: ...
__weak uint32_t SystemCoreClock = 180000000;
#endif /* STM32F427_437x || STM32F429_439xx */

#if defined (STM32F401xx)
// IIT-EXT: ...
__weak uint32_t SystemCoreClock = 84000000;
#endif /* STM32F401xx */

//IIT-EXT: made it constant to place it in flash
