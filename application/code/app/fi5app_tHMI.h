...
namespace fi5app { namespace tHMI { 
    ...
    {
        vnt::core::relTime periodOfTICK {66*vnt::core::time1millisec};
                
        constexpr Settings() : CoreSettings(8*1024, vnt::os::Priority::medium102, 100*vnt::core::time1millisec) {} 
